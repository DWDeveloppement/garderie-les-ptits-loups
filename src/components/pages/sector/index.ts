...
export type { SectorPageData } from '@/types/sanity/sectorPage'
...
export { LinkedSpacesSection, type LinkedSpacesSectionProps } from './LinkedSpacesSection'
export { ParallaxSection, type ParallaxSectionProps } from './ParallaxSection'
