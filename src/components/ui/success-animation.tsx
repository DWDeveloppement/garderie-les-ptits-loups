			...
			<div className="bg-white rounded-lg p-8 max-w-sm mx-4 text-center shadow-xl">
				...
				<div className="relative w-16 h-16 mx-auto mb-4">
					<div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center">
						<div className={`w-12 h-12 bg-green-500 rounded-full flex items-center justify-center transition-all duration-500 ${
					...
					{showCheckmark && (
						<>
							...
							<div className="absolute -bottom-2 -left-2 w-2 h-2 bg-green-400 rounded-full animate-ping" style={{ animationDelay: '0.2s' }}></div>
							<div className="absolute top-1 -left-3 w-2 h-2 bg-green-400 rounded-full animate-ping" style={{ animationDelay: '0.4s' }}></div>
						</>
					)}
				</div>
