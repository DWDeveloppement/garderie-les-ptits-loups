...
function Button(props: ButtonAsNextLinkProps | ButtonAsAnchorProps | ButtonAsButtonProps | ButtonAsDecorativeProps) {
	const { className, variant, size, asChild = false, ariaLabel, children, loading, asDecorative = false } = props

	const isNextLinkProps = (p: ButtonProps): p is ButtonAsNextLinkProps => (p as ButtonAsNextLinkProps).asNextLink === true
	const isAnchorLinkProps = (p: ButtonProps): p is ButtonAsAnchorProps => (p as ButtonAsAnchorProps).asLink === true
