			...
			{(finalTitle || finalSubtitle) && (
				<div className={`relative z-10 h-full flex flex-col justify-center px-4 sm:px-6 lg:px-8`}>
					<div
						...
						{finalTitle && <h2 className='font-bold text-white mb-4 drop-shadow-lg'>{finalTitle}</h2>}
						{finalSubtitle && <p className='text-orange-1 max-w-2xl leading-relaxed drop-shadow-md'>{finalSubtitle}</p>}
					</div>
				</div>
			)}
