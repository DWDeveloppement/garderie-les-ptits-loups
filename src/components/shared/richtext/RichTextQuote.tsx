...
const quoteVariants = cva(['relative my-6 pl-4 md:pl-6', 'border-l-4', 'leading-relaxed text-2xl italic'], {
	variants: {
		variant: {
	...
	return (
		<Card
			...
			<CardContent className='p-6 text-center'>
				<blockquote className={cn('text-2xl italic leading-relaxed mb-4', styles.quote)}>{content}</blockquote>
